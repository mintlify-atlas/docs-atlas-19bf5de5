...
<Steps>
  ...
  <Step title="Configure Environment">
    Copy the example below into a `.env` file at the project root. All variables are loaded at startup via `dotenv/config`.
  ...
  <Step title="Start the Server">
    ...
    ```
    2025-07-10T12:00:00.000Z [Backend] [SUCCESS] Servidor iniciado | {"puerto":3000}
    2025-07-10T12:00:00.000Z [Red]     [INFO]    Servicio mDNS anunciado | {"tipo":"_monitor._tcp"}
    2025-07-10T12:00:00.000Z [Red]     [INFO]    IP local | {"ip":"192.168.1.42"}
    2025-07-10T12:00:00.000Z [Red]     [INFO]    Nombre del servidor | {"hostname":"mi-mac","dns":"mi-mac.local"}
    2025-07-10T12:00:00.000Z [Sistema] [INFO]    ══════════ Iniciando verificación de estado ══════════
    2025-07-10T12:00:00.000Z [Sistema] [INFO]    ══════════ Verificación completada ══════════
    ```
