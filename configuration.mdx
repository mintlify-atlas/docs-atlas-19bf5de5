...
description: "All environment variables for Monitor API: DATABASE_URL, JWT_SECRET, and EVIDENCIAS_DIR. Includes hardcoded port details and structured logging behavior."
---
