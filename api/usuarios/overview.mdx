...
description: "Manage Monitor API user accounts. All endpoints require an active Administrador JWT. Supports listing, reading, updating, and deleting usuario records."
---
