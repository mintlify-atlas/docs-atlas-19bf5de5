---
title: "List Evidence Files for an Expediente"
sidebarTitle: "List Evidence"
description: "Retrieve all evidence records for an expediente ordered newest-first. Returns ID, filename, MIME type, upload timestamp, storage path, and uploader ID."
---
