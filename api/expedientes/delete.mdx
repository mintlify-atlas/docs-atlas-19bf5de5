---
title: "DELETE /api/expedientes/:no_siniestro — Remove an Expediente Record"
sidebarTitle: "DELETE /expedientes/:id"
description: "Permanently delete an expediente and its related records. Restricted to Administrador role. Returns a confirmation object on success."
---
...
<Warning>
  Deleting an expediente **cascades** to all of its child records within the same transaction. The following tables are purged in order before the expediente itself is removed:
