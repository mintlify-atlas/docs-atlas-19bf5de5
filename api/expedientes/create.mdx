---
title: "POST /api/expedientes — Create an Expediente Record"
sidebarTitle: "Create Expediente"
description: "Create a new expediente for an incoming vehicle. Requires a unique siniestro number and Administrador or Operador role. Initial status is always Ingreso."
---
