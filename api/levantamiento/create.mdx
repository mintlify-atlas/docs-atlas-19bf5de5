...
sidebarTitle: "Create Survey"
description: "Create a levantamiento de daños linked to an expediente. Supply vehicle details, damage flags, and optional inline concepts. Requires authentication."
---
...
<ParamField body="conceptos" type="array">
  ...
  If omitted or empty, the levantamiento is created with no concepts. Concepts can also be added later via [POST /api/levantamientos/:id/conceptos](/api/levantamiento/conceptos).
</ParamField>
